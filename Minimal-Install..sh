...
echo "Set scaling governor to performance"
 -n performance | tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor
...
echo "###################################################################################################"
sudo dnf builddep wayland 
sudo dnf builddep wlroot
sudo dnf builddep wlmirror
sudo dnf builddep xwayland
sudo dnf builddep libwayland-server 
sudo dnf builddep libwayland-client
sleep 2 
...
sudo dnf builddep sway 
sudo dnf builddep waybar
...
sudo dnf builddep weston
sudo dnf builddep gammactl
...
echo "###################################################################################################"
sudo dnf buildep wayfire
sudo dnf builddep hikari
sudo dnf buildep river 
...
sudo dnf builddep cutefish-core
sudo builddep cutefish-desktop-common
sudo builddep cutefish-desktop
